...
As usuárias do software, sejam consumidoras finais ou desenvolvedoras, são seres humanos que se preocupam com o que está no software. Quando o software muda, as pessoas querem saber o porquê e como. Ajuda as usuárias a decidirem se devem ou não atualizar para uma nova versão do software. Ajuda as desenvolvedoras a rastrear as mudanças que foram feitas no software e facilita a resolução de problemas quando algo dá errado.
...
Depois, ao terminar cada sprint, antes da cerimônia de _Sprint Review_, você deverá adicionar uma nova entrada no início do arquivo com os avanços e aprendizados do último sprint, usando o seguinte formato:
...
Nesta seção, liste os aprendizados do sprint.
...
# Consulta de commits no sprint

Você pode executar o seguinte comando para consultar as mensagens de commits que você fez nos últimos 7 dias em todos os branches do seu repositório e, assim, construir seu changelog:
